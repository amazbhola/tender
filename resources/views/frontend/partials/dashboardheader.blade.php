<div class="dashboard-header">
    ...
    <a class="navbar-brand" href="{{route('home')}}">Search Tender</a>
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto navbar-right-top">
                ...
                <li class="nav-item dropdown nav-user">
                    <div class="row">
                        <a class="nav-link nav-user-img" href="{{route('login')}}" id="" >Login </a>

                        <a class="nav-link nav-user-img" href="{{route('registeruser')}}" id="" >Register</a>
                    </div>
                </li>
                @endguest
            </ul>
